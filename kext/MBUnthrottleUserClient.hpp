...
class MBUnthrottleUserClient : public IOUserClient {
    OSDeclareDefaultStructors(MBUnthrottleUserClient)
...
private:
    MBUnthrottleService *owner_ = nullptr;
    static const IOExternalMethodDispatch methods_[kMBUSelectorCount];

    static IOReturn sGetStatus(OSObject *target,
                               void *reference,
                               IOExternalMethodArguments *arguments);
};
